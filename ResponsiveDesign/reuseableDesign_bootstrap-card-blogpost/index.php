<?php require_once ('snippets/HEADER.php');?>
    <div class="container">
            ...
            <div class="col-12">
                ...
                <div id="AwesomeCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item">
                            <img class="d-block img-fluid carouselImg" src="images/slider2.jpg"  alt="">
                            <div class="carousel-caption d-none d-md-block">
                                <h3>Mr. lion</h3>
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 cardContainer">
                <div class="card">
                    <a href="#">
                    ...
                    <div class="card-block">
                        ...
                        <p class="card-text">Looking for the next wave of breakthrough technology? It’s all around you.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 cardContainer">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <p class="card-text">Explore three futuristic Microsoft hardware labs.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 cardContainer">
